...
namespace WpfApp.Classes
{
    public class Mammal : Animal
    {
        ...
        public Mammal(string name, TypeOfFood typeOfFood, TypeOfHabitat habitat, TypeOfTherapy typeOfTherapy)
        {
            Name = name;
        ...
        {
            base.Heal();
            return "All limbs, torso, head and if there are wings were examined and damaged parts of the body were healed";
        }

        public override object Clone() => new Mammal(Name, TypeOfFood, Habitat, TypeOfTherapy);
    }
}